package com.qubartech.playque.di

import android.content.Context
import androidx.room.Room
import com.qubartech.playque.data.local.AppDatabase
import com.qubartech.playque.data.remote.ApiService
import com.qubartech.playque.models.NetworkResultCallAdapterFactory
import com.qubartech.playque.utils.Constants.BASE_URL
import com.qubartech.playque.utils.RemindersManager
        ...
        return OkHttpClient
            ...
            .addInterceptor {
                ...
                val url = originalHttpUrl.newBuilder()
                    ...
                    .addQueryParameter("maxResults", "10").build()
